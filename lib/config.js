...
module.exports = {
  ...
  binaries: {
    selenium: {
      version: '2.43.1',
      download: {
        name: 'selenium-server-standalone-2.43.1.jar',
        url: 'http://selenium-release.storage.googleapis.com/index.html?path=2.43/'
      },
      binary: {
        name: 'selenium-server-standalone-2.43.1.jar',
        path: path.resolve(SELENIUM_BINARIES_HOME, 'selenium', '2.43.1')
      }
    },
    chromedriver: {
      version: '2.10',
